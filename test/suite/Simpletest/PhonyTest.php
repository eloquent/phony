...
class PhonyTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $actual = Phony::stubGlobal('sprintf', 'Eloquent\Phony\Simpletest\Facade');
    ...
    {
        $actual = stubGlobal('vsprintf', 'Eloquent\Phony\Simpletest\Facade');
    ...
    private function assertSpyAssertionRecorder($spy)
    {
        ...
        $this->assertInstanceOf('Eloquent\Phony\Simpletest\SimpletestAssertionRecorder', $assertionRecorder);
    }
