...
class TraversableVerifierFactoryTest extends PHPUnit_Framework_TestCase
{
    protected function setUp()
    {
        ...
        $this->subject =
            new TraversableVerifierFactory($this->matcherFactory, $this->assertionRecorder, $this->assertionRenderer);
    ...
    public function testCreate()
    {
        ...
        $expected = new TraversableVerifier(
            $spy,
            $calls,
            $this->matcherFactory,
